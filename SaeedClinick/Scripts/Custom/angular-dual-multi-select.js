...
.directive('dualmultiselect', function () {
    return {
        ...
        controller: function ($scope) {
            ...
            $scope.labelSelected = $scope.options.labelSelected || '';
            $scope.labelAll = $scope.options.labelAll || '';
            $scope.buttonCheckAll = $scope.options.buttonCheckAll || 'select All';
            $scope.buttonDeselectAll = $scope.options.buttonDeselectAll || 'Deselect All';
